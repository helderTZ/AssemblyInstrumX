...
def sort_instructions():
    ...
    for i in range(len(compute_list)):
        if   'DP FP' in compute_list[i] and 'SIMD'   in compute_list[i]: dpfp_vector_indices.append(i)
        elif 'DP FP' in compute_list[i] and 'SCALAR' in compute_list[i]: dpfp_scalar_indices.append(i)
        elif 'DP FP'                                 in compute_list[i]: dpfp_others_indices.append(i)
        elif 'SP FP' in compute_list[i] and 'SIMD'   in compute_list[i]: spfp_vector_indices.append(i)
        elif 'SP FP' in compute_list[i] and 'SCALAR' in compute_list[i]: spfp_scalar_indices.append(i)
        elif 'SP FP'                                 in compute_list[i]: spfp_others_indices.append(i)
        elif 'INT'   in compute_list[i] and 'SIMD'   in compute_list[i]: int_vector_indices.append(i)
        elif 'INT'   in compute_list[i] and 'SCALAR' in compute_list[i]: int_scalar_indices.append(i)
    ...
    for i in range(len(memory_list)):
        if   'DP FP' in memory_list[i] and 'SIMD'   in memory_list[i]: dpfp_vector_indices.append(i)
        elif 'DP FP' in memory_list[i] and 'SCALAR' in memory_list[i]: dpfp_scalar_indices.append(i)
        elif 'DP FP'                                in memory_list[i]: dpfp_others_indices.append(i)
        elif 'SP FP' in memory_list[i] and 'SIMD'   in memory_list[i]: spfp_vector_indices.append(i)
        elif 'SP FP' in memory_list[i] and 'SCALAR' in memory_list[i]: spfp_scalar_indices.append(i)
        elif  'SP FP'                               in memory_list[i]: spfp_others_indices.append(i)
        elif 'INT'   in memory_list[i] and 'SIMD'   in memory_list[i]: int_vector_indices.append(i)
        elif 'INT'   in memory_list[i] and 'SCALAR' in memory_list[i]: int_scalar_indices.append(i)
    ...
    for i in range(len(comp_mem_list)):
        if   'DP FP' in comp_mem_list[i] and 'SIMD'   in comp_mem_list[i]: dpfp_vector_indices.append(i)
        elif 'DP FP' in comp_mem_list[i] and 'SCALAR' in comp_mem_list[i]: dpfp_scalar_indices.append(i)
        elif 'DP FP'                                  in comp_mem_list[i]: dpfp_others_indices.append(i)
        elif 'SP FP' in comp_mem_list[i] and 'SIMD'   in comp_mem_list[i]: spfp_vector_indices.append(i)
        elif 'SP FP' in comp_mem_list[i] and 'SCALAR' in comp_mem_list[i]: spfp_scalar_indices.append(i)
        elif 'SP FP'                                  in comp_mem_list[i]: spfp_others_indices.append(i)
        elif 'INT'   in comp_mem_list[i] and 'SIMD'   in comp_mem_list[i]: int_vector_indices.append(i)
        elif 'INT'   in comp_mem_list[i] and 'SCALAR' in comp_mem_list[i]: int_scalar_indices.append(i)
    ...
    for i in range(len(others_list)):
        if   'DP FP' in others_list[i] and 'SIMD'   in others_list[i]: dpfp_vector_indices.append(i)
        elif 'DP FP' in others_list[i] and 'SCALAR' in others_list[i]: dpfp_scalar_indices.append(i)
        elif 'DP FP'                                in others_list[i]: dpfp_others_indices.append(i)
        elif 'SP FP' in others_list[i] and 'SIMD'   in others_list[i]: spfp_vector_indices.append(i)
        elif 'SP FP' in others_list[i] and 'SCALAR' in others_list[i]: spfp_scalar_indices.append(i)
        elif 'SP FP'                                in others_list[i]: spfp_others_indices.append(i)
        elif 'INT'   in others_list[i] and 'SIMD'   in others_list[i]: int_vector_indices.append(i)
        elif 'INT'   in others_list[i] and 'SCALAR' in others_list[i]: int_scalar_indices.append(i)
